...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "AutocompleteErrorEvent|DOMError|ErrorEvent|Event|FileError|MediaError|MediaKeyError|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedString|SpeechRecognitionError"
  },
  JSBool: {
    "": "bool/Interceptor;",
    toString$0: function(receiver) {
  ...
  DocumentFragment: {
    ...
    get$children: function(receiver) {
      if (receiver._children == null)
        receiver._children = new P.FilteredElementList(receiver, new W._ChildNodeListLazy(receiver));
...
["", "index.dart", , E, {
  ...
  main: function() {
    ...
    if (R.admin_CheckAddress()) {
      var t1 = H.interceptedTypeCast(document.querySelector("#main_window"), "$isIFrameElement");
      t1.src = J.$add$ns(t1.src, "?admin");
      E.UpdateLinks(document.querySelector("#nav"), "?admin");
    }
  },
  UpdateLinks: function(ul, ext) {
    var t1, t2, e, t3;
    for (t1 = J.get$children$x(ul), t1 = t1.get$iterator(t1); t1.moveNext$0();)
      for (t2 = J.get$iterator$ax(J.get$children$x(t1._current)); t2.moveNext$0();) {
        e = t2.get$current();
        t3 = J.getInterceptor(e);
        if (typeof e === "object" && e !== null && !!t3.$isAnchorElement)
          e.href = J.$add$ns(e.href, ext);
        else if (typeof e === "object" && e !== null && !!t3.$isUListElement)
          E.UpdateLinks(e, ext);
      }
  }
},
