...
["TextArea", "TextArea.dart", , G, {
  "": "",
  TextArea: {
    "": "Object;_TextArea0$_element",
    TextArea$2: function(rows, cols) {
      var t1 = document.createElement("textarea", null);
      this._TextArea0$_element = t1;
      J.set$cols$x(t1, cols);
      J.set$rows$x(this._TextArea0$_element, rows);
      J.set$maxLength$x(this._TextArea0$_element, 1024);
    }
  }
}],
...
["", "about_us.dart", , L, {
  ...
  main: [function() {
    P.print("hej");
    if (R.admin_CheckAddress())
      R.admin_GenerateEditButtons("json/about_us.json");
    W.HttpRequest_getString("json/about_us.json", null, null).then$1(new L.main_closure());
  }, "call$0", "main$closure", 0, 0, 0],
  main_closure: {
    "": "Closure:13;",
    call$1: function(response_text) {
      var $content, t1;
      $content = C.C_JsonCodec.decode$1(response_text);
      t1 = J.getInterceptor$asx($content);
      J.setInnerHtml$1$x(H.interceptedTypeCast(document.querySelector("#about_us_paragraph"), "$isParagraphElement"), t1.$index($content, "about_us_paragraph"));
      J.setInnerHtml$1$x(H.interceptedTypeCast(document.querySelector("#about_us_header"), "$isHeadingElement"), t1.$index($content, "about_us_header"));
    }
  }
},
1],
["admin", "admin.dart", , R, {
  "": "",
  admin_GenerateEditButtons: function(filename) {
    var t1, editableItems, t2, t3, e, t4, parentRect, rect, t5, t6, t7, t8, editButton, t9, elemValue;
    t1 = $.get$admin__jsonValues();
    t1.clear$0(t1);
    editableItems = W._FrozenElementList$_wrap(document.querySelectorAll(".editable"), null);
    for (t1 = editableItems.get$iterator(editableItems), t2 = C.EventStreamProvider_click._eventType; t1.moveNext$0();) {
      t3 = {};
      e = t1._dev$_current;
      t4 = J.getInterceptor$x(e);
      parentRect = J.getBoundingClientRect$0$x(t4.get$parent(e));
      rect = t4.getBoundingClientRect$0(e);
      ...
      if (typeof t6 !== "number")
        return H.iae(t6);
      t7 = J.getInterceptor$x(parentRect);
      t8 = t7.get$left(parentRect);
      if (typeof t8 !== "number")
        return H.iae(t8);
      editButton = document.createElement("button", null);
      J.set$innerHtml$x(editButton, "edit");
      J.set$position$x(editButton.style, "absolute");
      t9 = editButton.style;
      t4 = t4.get$top(rect);
      t7 = t7.get$top(parentRect);
      if (typeof t4 !== "number")
        return t4.$sub();
      if (typeof t7 !== "number")
        return H.iae(t7);
      J.set$top$x(t9, C.JSDouble_methods.toString$0(t4 - t7 - 5) + "px");
      J.set$left$x(editButton.style, C.JSDouble_methods.toString$0(t5 + t6 - t8 - 60) + "px");
      t8 = new W._ElementEventStreamImpl(editButton, t2, false);
      t8.$builtinTypeInfo = [null];
      t4 = new W._EventStreamSubscription(0, editButton, t2, W._wrapZone(new R.admin_GenerateEditButtons_closure(filename, e)), false);
      t4.$builtinTypeInfo = [H.getTypeArgumentByIndex(t8, 0)];
      t5 = t4._onData;
      if (t5 != null && t4._pauseCount <= 0)
        J.addEventListener$3$x(t4._target, t2, t5, false);
      J.set$zIndex$x(editButton.style, "99");
      t4 = J.get$children$x(e.parentElement);
      t4.add$1(t4, editButton);
      t3.elemValue_0 = "";
      switch (e.nodeName) {
        case "P":
          elemValue = H.interceptedTypeCast(e, "$isParagraphElement").innerHTML;
          t3.elemValue_0 = elemValue;
          t4 = elemValue;
          break;
        case "H3":
          elemValue = H.interceptedTypeCast(e, "$isHeadingElement").innerHTML;
          t3.elemValue_0 = elemValue;
          t4 = elemValue;
          break;
        case "IMG":
          elemValue = H.interceptedTypeCast(e, "$isImageElement").src;
          t3.elemValue_0 = elemValue;
          t4 = elemValue;
          break;
        default:
      ...
      if (t4 !== "")
        $.get$admin__jsonValues().putIfAbsent$2(e.id, new R.admin_GenerateEditButtons_closure0(t3));
    }
  },
  admin_CheckAddress: function() {
    var $location, t1, index;
    $location = J.toString$0(C.Window_methods.get$location(window));
    t1 = J.getInterceptor$asx($location);
    index = t1.indexOf$2($location, "?", 0);
    if (index >= 0 && t1.substring$2($location, index + 1, t1.get$length($location)) === "admin")
      return true;
    return false;
  },
  admin_CreatePropertyWindow: function(e, filename) {
    var form, buttonSave, buttonClose, t1, elem, textArea;
    form = document.createElement("form", null);
    J.set$action$x(form, "http://www.appfoundry.se/superherbal/fileserver.php");
    form.method = "POST";
    buttonSave = W.InputElement_InputElement("submit");
    buttonClose = document.createElement("button", null);
    buttonClose.textContent = "Close";
    J.set$value$x(buttonSave, "Save");
    $.get$admin__propertyWindow().id = "property_window";
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(buttonClose, C.EventStreamProvider_click._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.admin_CreatePropertyWindow_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    switch (e.nodeName) {
      case "H3":
        elem = W.InputElement_InputElement("text");
        new A.InputField(null)._elem = elem;
        J.set$maxLength$x(elem, 1024);
        J.set$value$x(elem, H.interceptedTypeCast(e, "$isHeadingElement").innerHTML);
        break;
      case "P":
        textArea = new G.TextArea(null);
        textArea.TextArea$2(25, 60);
        J.set$value$x(textArea._TextArea0$_element, H.interceptedTypeCast(e, "$isParagraphElement").innerHTML);
        elem = textArea._TextArea0$_element;
        break;
      case "IMG":
        elem = W.InputElement_InputElement("text");
        new A.InputField(null)._elem = elem;
        J.set$maxLength$x(elem, 1024);
        J.set$value$x(elem, H.interceptedTypeCast(e, "$isImageElement").src);
        break;
      default:
        elem = null;
        break;
    ...
    if (elem != null) {
      ...
      if (typeof elem === "object" && elem !== null && !!t1.$isTextAreaElement)
        elem.name = e.id;
      else if (typeof elem === "object" && elem !== null && !!t1.$isInputElement)
        elem.name = e.id;
    }
    form.appendChild(buttonSave);
    form.appendChild(buttonClose);
    t1 = J.get$children$x($.get$admin__propertyWindow());
    t1.add$1(t1, form);
    t1 = document.body;
    t1.children;
    t1.appendChild($.get$admin__propertyWindow());
  },
  admin_GenerateEditButtons_closure: {
    "": "Closure:11;filename_1,e_2",
    call$1: function(_) {
      return R.admin_CreatePropertyWindow(this.e_2, this.filename_1);
    }
  },
  admin_GenerateEditButtons_closure0: {
    "": "Closure:9;box_0",
    call$0: function() {
      return this.box_0.elemValue_0;
    }
  },
  admin_CreatePropertyWindow_closure: {
    "": "Closure:14;",
    call$1: function(e) {
      var t1;
      ...
      t1.clear$0(t1);
      t1 = document.body;
      t1 = new W._ChildrenElementList(t1, t1.children);
      t1.remove$1(t1, $.get$admin__propertyWindow());
    }
  }
}],
...
["dart.async", "dart:async", , P, {
  ...
  _AsyncCompleter: {
    ...
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 15, 3],
    $as_Completer: null
  },
  _Future: {
...
["dart.dom.html", "dart:html", , W, {
  ...
  InputElement: {
    "": "HtmlElement;maxLength},name=,type},value%",
    $isInputElement: true,
    $isElement: true,
    "%": "HTMLInputElement"
  },
  ...
  TextAreaElement: {
    "": "HtmlElement;cols},maxLength},name=,rows},value%",
...
J.set$action$x = function(receiver, value) {
  return J.getInterceptor$x(receiver).set$action(receiver, value);
};
...
Isolate.$lazy($, "_jsonValues", "admin__jsonValues", "get$admin__jsonValues", function() {
  return P.LinkedHashMap_LinkedHashMap(null, null, null, J.JSString, J.JSString);
});
Isolate.$lazy($, "_propertyWindow", "admin__propertyWindow", "get$admin__propertyWindow", function() {
...
function dart_precompiled($collectedClasses) {
  ...
  FormElement.prototype.set$action = function(receiver, v) {
    return receiver.action = v;
  };
  ...
  TextAreaElement.prototype.set$cols = function(receiver, v) {
    return receiver.cols = v;
  };
  ...
  TextAreaElement.prototype.set$rows = function(receiver, v) {
    return receiver.rows = v;
  };
  ...
  function TextArea(_TextArea0$_element) {
    this._TextArea0$_element = _TextArea0$_element;
  }
  TextArea.builtin$cls = "TextArea";
  if (!"name" in TextArea)
    TextArea.name = "TextArea";
  $desc = $collectedClasses.TextArea;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TextArea.prototype = $desc;
  ...
  function admin_GenerateEditButtons_closure(filename_1, e_2) {
    this.filename_1 = filename_1;
    this.e_2 = e_2;
  }
  admin_GenerateEditButtons_closure.builtin$cls = "admin_GenerateEditButtons_closure";
  if (!"name" in admin_GenerateEditButtons_closure)
    admin_GenerateEditButtons_closure.name = "admin_GenerateEditButtons_closure";
  $desc = $collectedClasses.admin_GenerateEditButtons_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  admin_GenerateEditButtons_closure.prototype = $desc;
  function admin_GenerateEditButtons_closure0(box_0) {
    this.box_0 = box_0;
  }
  admin_GenerateEditButtons_closure0.builtin$cls = "admin_GenerateEditButtons_closure0";
  if (!"name" in admin_GenerateEditButtons_closure0)
    admin_GenerateEditButtons_closure0.name = "admin_GenerateEditButtons_closure0";
  $desc = $collectedClasses.admin_GenerateEditButtons_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  admin_GenerateEditButtons_closure0.prototype = $desc;
  function admin_CreatePropertyWindow_closure() {
  }
  admin_CreatePropertyWindow_closure.builtin$cls = "admin_CreatePropertyWindow_closure";
  if (!"name" in admin_CreatePropertyWindow_closure)
    admin_CreatePropertyWindow_closure.name = "admin_CreatePropertyWindow_closure";
  $desc = $collectedClasses.admin_CreatePropertyWindow_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  admin_CreatePropertyWindow_closure.prototype = $desc;
